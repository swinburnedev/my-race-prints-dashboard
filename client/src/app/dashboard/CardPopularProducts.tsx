                    ...
                    <div className="overflow-auto h-full">
                        {dashboardMetrics?.popularProducts.map(product => (
                            <div
                                ...
                                className="flex items-center justify-between gap-3 px-5 py-7 border-"
                            >
                                <div className="flex items-center gap-3">
                                    <img src="" alt={product.name} className="w-12 h-12 object-cover rounded-md" />
                                ...
                                <div className="text-xs flex items-center">
                                    <button className="-2 rounded-full bg-blue-100 text-blue-600 mr-2">
